...
import p_cc_rgb_to_lab
import p_cc_lab_to_rgb
...
def rein(
    ...
    im_lab = p_cc_rgb_to_lab.rgb_to_lab(im_src)
    ...
    # calculate src_mu(mean) and src_sigma(stdev) if either is not provided
    ...
    im_normalized = p_cc_lab_to_rgb.lab_to_rgb(im_lab)
